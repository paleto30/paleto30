...
- **[impactwave](https://www.npmjs.com/package/impactwave)** · proyecto personal (2026): paquete publicable en npm con `npx impactwave` — CLI que analiza los cambios de Git antes del merge y calcula el blast radius vía AST (ts-morph), la cobertura de impacto y un risk score determinístico 0–100 con razones explicables. *(Código: [paleto30/impactwave](https://github.com/paleto30/impactwave))*
